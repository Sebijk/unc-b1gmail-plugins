<form method="post" name="f1" action="{$pageURL}&amp;action=knowledgebase&amp;do=addCategory&amp;sid={$sid}">
	<fieldset>
		<legend>{lng p="tcsup.kategorie_hinzufuegen"}</legend>
			<table width="100%">
				<tr>
					...
					<td class="td2"><input type="text" style="width:85%;" name="name" value="" /></td>
				</tr>
				<tr>
					<td class="td1" width="150">{lng p="tcsup.beschreibung"}:</td>
					<td class="td2"><input type="text" style="width:85%;" name="description" value="" /></td>
				</tr>
				<tr>
